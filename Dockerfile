...
# docker image build --build-arg NEXT_PUBLIC_GOOGLE_CLIENT_ID=$NEXT_PUBLIC_GOOGLE_CLIENT_ID --build-arg NEXT_PUBLIC_BASE_DOMAIN_API=$NEXT_PUBLIC_BASE_DOMAIN_API --build-arg NEXT_PUBLIC_BASE_DOMAIN_CLOUDINARY=$NEXT_PUBLIC_BASE_DOMAIN_CLOUDINARY -t vulebaolong/img-fe_main:latest .